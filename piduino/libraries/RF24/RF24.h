...
public:
 ...
 void disableDynamicPayloads(void);
   ...
   */
  bool whatHappened(bool& tx_ok,bool& tx_fail,bool& rx_ready);
   ...
   * @param[out] tx_fail The send failed, too many retries (MAX_RT)
   * @param[out] rx_ready There is a message waiting to be read (RX_DS)
   * @param[out] tx_full The TX buffer is full (TX_FULL)
   * @param[out] rx_pipe The pipe number that got the message(7 == RX_FIFO Empty) (RX_P_NO)
   */
  bool whatHappened(bool& tx_ok,bool& tx_fail,bool& rx_ready,bool& tx_full, uint8_t& rx_pipe);
